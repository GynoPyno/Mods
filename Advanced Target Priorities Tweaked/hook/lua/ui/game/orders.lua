...
local textures = '/mods/Advanced Target Priorities Tweaked/textures/'
local originalOrderTogglesTable = OrderTogglesTable
...
local prioStateTextures = {
    ...
    --Volatile = textures..'volatile.dds',
    PD = textures..'PD.dds',
    Units = textures..'units.dds',
    Shields = textures..'shields.dds',
    EXP = textures..'EXP.dds',
    Engies = textures..'engies.dds',
    --MArty = textures..'marty.dds',
    --AAFighter = textures..'AAFighter.dds',
    --MslDef = textures..'MslDef.dds',
    --BmbrGS = textures..'bmbrgs.dds',
    --Mass = textures..'mass.dds',
    ...
    --NavalSup = textures..'NavalSup.dds',
}
...
function CreatePrioButtons(parent)
    ...
    buttons.settings.OnCheck = function(control, checked)
        if not createSettingsWindow then
            createSettingsWindow = import('/mods/Advanced Target Priorities Tweaked/modules/settings.lua').CreateSettingsWindow
        end
...
OrderTogglesTable.Attack.ToggleFromOff = function() SetWeaponPriorities(PrioritySettings.priorityTables.Snipe, "Snipe", false) end
